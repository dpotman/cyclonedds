...
static const uint32_t DDS_Builtin_TypeLookup_Request_ops [] =
{
  ...
  /* TypeLookup_Call */
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN, offsetof (DDS_Builtin_TypeLookup_Call, _d), 2u, (10u << 16u) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 7 /* TypeLookup_getTypes_In */, 25318099, offsetof (DDS_Builtin_TypeLookup_Call, _u.getTypes),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 165 /* TypeLookup_getTypeDependencies_In */, 95091505, offsetof (DDS_Builtin_TypeLookup_Call, _u.getTypeDependencies),
  DDS_OP_RTS,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_UNI, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_In, type_ids), sizeof (DDS_XTypes_TypeIdentifier), (4u << 16u) + 65378u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_JEQ | DDS_OP_TYPE_UNI | 786 /* TypeLookup_getTypeDependencies_Result */, 95091505, offsetof (DDS_Builtin_TypeLookup_Return, _u.getTypeDependencies),
  DDS_OP_RTS,

  /* TypeLookup_getTypes_Result */
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN, offsetof (DDS_Builtin_TypeLookup_getTypes_Result, _d), 1u, (7u << 16u) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 4 /* TypeLookup_getTypes_Out */, 0, offsetof (DDS_Builtin_TypeLookup_getTypes_Result, _u.result),
  DDS_OP_RTS,
  ...
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_Builtin_TypeLookup_getTypes_Out, complete_to_minimal), sizeof (DDS_XTypes_TypeIdentifierPair), (4u << 16u) + 756u /* TypeIdentifierPair */,
  DDS_OP_RTS,

  /* TypeIdentifierTypeObjectPair */
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierTypeObjectPair, type_identifier), (3u << 16u) + 65335u /* TypeIdentifier */,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierTypeObjectPair, type_object), (3u << 16u) + 4u /* TypeObject */,
  DDS_OP_RTS,
  ...
  DDS_OP_JEQ | DDS_OP_TYPE_UNI | 484 /* MinimalTypeObject */, 241, offsetof (DDS_XTypes_TypeObject, _u.minimal),
  DDS_OP_RTS,
  ...
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 170 /* CompleteAnnotationType */, 80, offsetof (DDS_XTypes_CompleteTypeObject, _u.annotation_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 199 /* CompleteStructType */, 81, offsetof (DDS_XTypes_CompleteTypeObject, _u.struct_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 241 /* CompleteUnionType */, 82, offsetof (DDS_XTypes_CompleteTypeObject, _u.union_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 292 /* CompleteBitsetType */, 83, offsetof (DDS_XTypes_CompleteTypeObject, _u.bitset_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 322 /* CompleteSequenceType */, 96, offsetof (DDS_XTypes_CompleteTypeObject, _u.sequence_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 361 /* CompleteArrayType */, 97, offsetof (DDS_XTypes_CompleteTypeObject, _u.array_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 379 /* CompleteMapType */, 98, offsetof (DDS_XTypes_CompleteTypeObject, _u.map_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 388 /* CompleteEnumeratedType */, 64, offsetof (DDS_XTypes_CompleteTypeObject, _u.enumerated_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 420 /* CompleteBitmaskType */, 65, offsetof (DDS_XTypes_CompleteTypeObject, _u.bitmask_type),
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 444 /* CompleteExtendedType */, 0, offsetof (DDS_XTypes_CompleteTypeObject, _u.extended_type),
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteAliasType, body), (3u << 16u) + 104u /* CompleteAliasBody */,
  DDS_OP_RTS,
  ...
  /* AppliedAnnotation */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_AppliedAnnotation, annotation_typeid), (3u << 16u) + 65238u /* TypeIdentifier */,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_XTypes_CompleteAliasBody, ann_custom), sizeof (DDS_XTypes_AppliedAnnotation), (4u << 16u) + 65459u /* AppliedAnnotation */,
  DDS_OP_RTS,

  /* CommonAliasBody */
  DDS_OP_ADR | DDS_OP_TYPE_2BY, offsetof (DDS_XTypes_CommonAliasBody, related_flags),
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonAliasBody, related_type), (3u << 16u) + 65155u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonAnnotationParameter, member_type_id), (3u << 16u) + 65111u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteStructHeader, base_type), (3u << 16u) + 65096u /* TypeIdentifier */,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonStructMember, member_type_id), (3u << 16u) + 65077u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_XTypes_CompleteMemberDetail, ann_custom), sizeof (DDS_XTypes_AppliedAnnotation), (4u << 16u) + 65364u /* AppliedAnnotation */,
  DDS_OP_RTS,
  ...
  /* CompleteUnionHeader */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteUnionHeader, detail), (3u << 16u) + 65320u /* CompleteTypeDetail */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteDiscriminatorMember, ann_builtin), (3u << 16u) + 65323u /* AppliedBuiltinTypeAnnotations */,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_XTypes_CompleteDiscriminatorMember, ann_custom), sizeof (DDS_XTypes_AppliedAnnotation), (4u << 16u) + 65334u /* AppliedAnnotation */,
  DDS_OP_RTS,

  /* CommonDiscriminatorMember */
  DDS_OP_ADR | DDS_OP_TYPE_2BY, offsetof (DDS_XTypes_CommonDiscriminatorMember, member_flags),
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonDiscriminatorMember, type_id), (3u << 16u) + 65030u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonUnionMember, type_id), (3u << 16u) + 65014u /* TypeIdentifier */,
  ...
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteBitsetHeader, detail), (3u << 16u) + 65268u /* CompleteTypeDetail */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteCollectionHeader, detail), (3u << 16u) + 65234u /* CompleteTypeDetail */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CommonCollectionElement, type), (3u << 16u) + 64945u /* TypeIdentifier */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteArrayHeader, detail), (3u << 16u) + 65191u /* CompleteTypeDetail */,
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_CompleteEnumeratedHeader, detail), (3u << 16u) + 65158u /* CompleteTypeDetail */,
  DDS_OP_RTS,
  ...
  /* MinimalStructHeader */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_MinimalStructHeader, base_type), (3u << 16u) + 64748u /* TypeIdentifier */,
  ...
  /* TypeIdentifierPair */
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierPair, type_identifier1), (3u << 16u) + 64584u /* TypeIdentifier */,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierPair, type_identifier2), (3u << 16u) + 64581u /* TypeIdentifier */,
  DDS_OP_RTS,

  /* TypeLookup_getTypeDependencies_Result */
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_Result, _d), 1u, (7u << 16u) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_STU | 4 /* TypeLookup_getTypeDependencies_Out */, 0, offsetof (DDS_Builtin_TypeLookup_getTypeDependencies_Result, _u.result),
  DDS_OP_RTS,
  ...
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierWithSize, type_id), (3u << 16u) + 64554u /* TypeIdentifier */,
...
{
  sizeof (DDS_Builtin_TypeLookup_Request),
  8u,
...
static const uint32_t DDS_Builtin_TypeLookup_Reply_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_UNI | DDS_OP_SUBTYPE_4BY | DDS_OP_FLAG_SGN, offsetof (DDS_Builtin_TypeLookup_Return, _d), 2u, (10u << 16u) + 4u,
  DDS_OP_JEQ | DDS_OP_TYPE_UNI | 7 /* TypeLookup_getTypes_Result */, 25318099, offsetof (DDS_Builtin_TypeLookup_Return, _u.getType),
  DDS_OP_JEQ | DDS_OP_TYPE_UNI | 938 /* TypeLookup_getTypeDependencies_Result */, 95091505, offsetof (DDS_Builtin_TypeLookup_Return, _u.getTypeDependencies),
  DDS_OP_RTS,
  ...
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_Builtin_TypeLookup_getTypes_Out, types), sizeof (DDS_XTypes_TypeIdentifierTypeObjectPair), (4u << 16u) + 10u /* TypeIdentifierTypeObjectPair */,
  DDS_OP_RTS,
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_Builtin_TypeLookup_getTypes_Out, complete_to_minimal), sizeof (DDS_XTypes_TypeIdentifierPair), (4u << 16u) + 908u /* TypeIdentifierPair */,
  DDS_OP_RTS,
  ...
  /* TypeIdentifierWithSize */
  DDS_OP_DLC,
  DDS_OP_ADR | DDS_OP_TYPE_EXT, offsetof (DDS_XTypes_TypeIdentifierWithSize, type_id), (3u << 16u) + 64610u /* TypeIdentifier */,
  DDS_OP_ADR | DDS_OP_TYPE_4BY, offsetof (DDS_XTypes_TypeIdentifierWithSize, typeobject_serialized_size),
  DDS_OP_RTS
};
...
{
  sizeof (DDS_Builtin_TypeLookup_Reply),
  8u,
  DDS_TOPIC_NO_OPTIMIZE | DDS_TOPIC_CONTAINS_UNION,
  0u,
