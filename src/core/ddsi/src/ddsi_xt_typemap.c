...
static const uint32_t DDS_XTypes_TypeMapping_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_STU, offsetof (DDS_XTypes_TypeMapping, identifier_complete_minimal), sizeof (DDS_XTypes_TypeIdentifierPair), (4u << 16u) + 929u /* TypeIdentifierPair */,
  DDS_OP_RTS,
