/****************************************************************
  ...
  File name: typelookup.h
  Source: typelookup.idl
  Cyclone DDS: V0.8.0

*****************************************************************/
#ifndef DDSC_TYPELOOKUP_H
#define DDSC_TYPELOOKUP_H
...
typedef struct DDS_SampleIdentity
{
  ...
  DDS_SequenceNumber sequence_number;
} DDS_SampleIdentity;
...
typedef struct DDS_Builtin_TypeLookup_getTypes_Result
{
  ...
  union
  {
    DDS_Builtin_TypeLookup_getTypes_Out result;
  } _u;
...
typedef struct DDS_Builtin_TypeLookup_getTypeDependencies_Result
{
  ...
  union
  {
    DDS_Builtin_TypeLookup_getTypeDependencies_Out result;
  } _u;
...
typedef struct DDS_Builtin_TypeLookup_Call
{
  ...
  union
  {
    DDS_Builtin_TypeLookup_getTypes_In getTypes;
    DDS_Builtin_TypeLookup_getTypeDependencies_In getTypeDependencies;
  } _u;
...
typedef struct DDS_Builtin_TypeLookup_Request
{
  ...
  DDS_Builtin_TypeLookup_Call data;
...
typedef struct DDS_Builtin_TypeLookup_Return
{
  ...
  union
  {
    DDS_Builtin_TypeLookup_getTypes_Result getType;
    DDS_Builtin_TypeLookup_getTypeDependencies_Result getTypeDependencies;
  } _u;
...
{
  DDS_RPC_RequestHeader header;
  DDS_Builtin_TypeLookup_Return return_data;
