...
typedef struct DDS_XTypes_StronglyConnectionComponentType
{
  DDS_XTypes_StronglyConnectedComponent scc;
} DDS_XTypes_StronglyConnectionComponentType;

DDS_EXPORT extern const dds_topic_descriptor_t DDS_XTypes_StronglyConnectionComponentType_desc;

#define DDS_XTypes_StronglyConnectionComponentType__alloc() \
((DDS_XTypes_StronglyConnectionComponentType*) dds_alloc (sizeof (DDS_XTypes_StronglyConnectionComponentType)));

#define DDS_XTypes_StronglyConnectionComponentType_free(d,o) \
dds_sample_free ((d), &DDS_XTypes_StronglyConnectionComponentType_desc, (o))
